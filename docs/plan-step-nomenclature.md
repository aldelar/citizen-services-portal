...
| **SCH** | Schedule | Book appointments/pickups | Schedule inspection, Schedule bulky pickup, HHW drop-off |
...
**Typical Flow:** `DOC → APP → (processing) → ENR or SCH`

### SCH - Schedule
Schedule steps involve booking appointments, pickups, or drop-offs.

**Agency Coverage:**
- **LADBS**: Inspection appointments
- **LADWP**: Service appointments
- **LASAN**: Bulky item pickup, Hazardous waste drop-off

**Typical Flow:** `APP or INS → SCH`
