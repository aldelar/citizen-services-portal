"""Configuration management for LASAN MCP server."""
...
class Settings(BaseSettings):
    ...
    # LASAN service configuration
    lasan_api_endpoint: Optional[str] = Field(default=None, alias="LASAN_API_ENDPOINT")
    lasan_api_key: Optional[str] = Field(default=None, alias="LASAN_API_KEY")
