metadata description = 'Deploys the Reporting MCP server to Azure Container Apps.'
...
param containerAppName string = 'aldelar-csp-mcp-reporting'
...
resource containerApp 'Microsoft.App/containerApps@2023-05-01' = {
  ...
  location: location
  tags: union(tags, { 'azd-service-name': 'mcp-reporting' })
