metadata description = 'Deploys the CSP MCP server to Azure Container Apps.'
...
param containerAppName string = 'aldelar-csp-mcp-csp'
...
// Note: CSP database and containers are now defined in core/data/cosmos-db.bicep
// No separate cosmos module needed here

resource containerApp 'Microsoft.App/containerApps@2023-05-01' = {
  name: containerAppName
  location: location
  tags: union(tags, { 'azd-service-name': 'mcp-csp' })
