metadata description = 'Deploys the LASAN MCP server to Azure Container Apps.'
...
param containerAppName string = 'aldelar-csp-mcp-lasan'
...
resource containerApp 'Microsoft.App/containerApps@2023-05-01' = {
  ...
  location: location
  tags: union(tags, { 'azd-service-name': 'mcp-lasan' })
      ...
      containers: [
        {
          ...
          env: concat(
            ...
            !empty(lasanApiEndpoint) ? [
              {
                name: 'LASAN_API_ENDPOINT'
                value: lasanApiEndpoint
              }
            ] : [],
            !empty(lasanApiKey) ? [
              {
